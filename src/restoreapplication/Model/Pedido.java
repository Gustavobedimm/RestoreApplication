...
public class Pedido {
    ...
    public String getDATAEFE() {
        return DATAEFE;
    }

    public void setDATAEFE(String DATAEFE) {
        this.DATAEFE = DATAEFE;
    }

    public String getHORAEFE() {
        return HORAEFE;
    }

    public void setHORAEFE(String HORAEFE) {
        this.HORAEFE = HORAEFE;
    }
    ...
    public String getSEQUENCIALPAF() {
        return SEQUENCIALPAF;
    }

    public void setSEQUENCIALPAF(String SEQUENCIALPAF) {
        this.SEQUENCIALPAF = SEQUENCIALPAF;
    }

    public String getPEDIDOAGRUPAMENTO() {
        return PEDIDOAGRUPAMENTO;
    }
